...
• Transkript POST na Make ➜ Make vrátí pole nových bodů
• Flipchart: NADPIS tučně + podbody s "•", funguje pro oba formáty:
      1) NADPIS\n- bod 1\n- bod 2
      2) NADPIS - bod 1 - bod 2
...
def format_point(raw: str) -> str:
    ...
    Podporuje formát:
       • víceřádkový: 'NADPIS\\n- detail'
       • jednořádkový: 'NADPIS - detail - detail'
    """
    raw = raw.strip()
    # rozhodni, jak rozseknout text
    if "\n" in raw:
